...
def create_namespace(namespace_name, cpu_limit, memory_limit):
    ...
    try:
        ...
        resource_quota = client.V1ResourceQuota(
            ...
            spec=client.V1ResourceQuotaSpec(
                hard={"limits.cpu": cpu_limit, "limits.memory": memory_limit}
            ),
        )
...
if __name__ == "__main__":
    ...
    # Set the desired namespace name, CPU limit, and memory limit
    namespace_name = "my-namespace"
    cpu_limit = "2"
    memory_limit = "2Gi"

    # Create the namespace and reserve capacity
    create_namespace(namespace_name, cpu_limit, memory_limit)
